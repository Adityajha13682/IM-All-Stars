  ...
  return (
    ...
    >
      ...
      {showContactModal && (
        ...
        >
          <div 
            className="relative max-w-md w-full rounded-3xl bg-gradient-to-br from-[#111827] via-[#020617] to-[#020617] border border-violet-500/30 shadow-2xl backdrop-blur-xl p-8 space-y-6"
          ...
          >
            ...
            <div className="flex justify-center">
              <div className="h-16 w-16 rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center ring-4 ring-violet-500/20">
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="w-full px-6 py-3 rounded-full text-base font-semibold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-violet-500/50 text-center"
              >
                Call Now
              </a>
              <button
                onClick={handleCopyNumber}
                className="w-full px-6 py-3 rounded-full text-base font-semibold text-white bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-200"
              >
                Copy Number
              </button>
            </div>
